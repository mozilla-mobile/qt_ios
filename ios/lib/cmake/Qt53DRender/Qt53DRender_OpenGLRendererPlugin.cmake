...
_qt5_3DRender_process_prl_file(
    "${_qt53DRender_install_prefix}/plugins/renderers/libopenglrenderer_debug.prl" DEBUG
    _Qt5OpenGLRendererPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
    _Qt5OpenGLRendererPlugin_STATIC_DEBUG_LINK_FLAGS
)
...
_populate_3DRender_plugin_properties(OpenGLRendererPlugin RELEASE "renderers/libopenglrenderer.a" TRUE)
_populate_3DRender_plugin_properties(OpenGLRendererPlugin DEBUG "renderers/libopenglrenderer_debug.a" TRUE)
...
set_property(TARGET Qt5::OpenGLRendererPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::3DRender;Qt5::3DCore;Qt5::3DRender;Qt5::3DCore;Qt5::Gui;Qt5::OpenGLExtensions;Qt5::Gui;Qt5::Core;Qt5::Core"
)
